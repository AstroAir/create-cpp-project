...
void initializeLogger(bool verbose) {
    try {
        // Initialize UTF-8 support first
        utils::TerminalUtils::initializeUtf8Support();
        ...
        // rotated files
        auto file_sink = std::make_shared<spdlog::sinks::rotating_file_sink_mt>("cpp-scaffold.log",
                                                                                5 * 1024 * 1024, 3);
...
int main(int argc, char* argv[]) {
    try {
        ...
        // Show application start screen
        std::cout << "C++ Project Scaffold - Create modern C++ projects with ease\n\n";
        ...
        if (argc <= 1) {
            std::cout << "Interactive mode not fully implemented yet.\n";
            std::cout << "Please use command line arguments. Use --help for usage information.\n";
            return 1;
        }
        ...
        if (success) {
            ...
            std::cout << "Project location: " << options.projectName << "\n";
        } else {
            std::cout << "Project creation failed. Check the logs for details.\n";
        }
        ...
        std::cerr << "Check the log file for more details and try running with --verbose\n";
        ...
        std::cerr << "Please report this issue on GitHub with your system information\n";
