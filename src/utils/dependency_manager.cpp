...
static Dependency createDependency(const std::string& name, const std::string& version,
                                   ...
                                   const std::vector<std::string>& features, bool required,
                                   bool headerOnly, const std::string& repository,
...
bool DependencyManager::installDependencies(const CliOptions& options) {
    ...
    TerminalUtils::showNpmStyleProgress("Installing dependencies", 40,
    ...
    switch (options.packageManager) {
        ...
        case PackageManager::Hunter:
            TerminalUtils::showNpmStyleProgress("Installing dependencies", 60,
                                                "Configuring Hunter");
        ...
        default:
            TerminalUtils::showNpmStyleWarning("No package manager selected",
...
::std::vector<Dependency> DependencyManager::getRecommendedDependencies(TemplateType templateType) {
    ...
    switch (templateType) {
        case TemplateType::Console:
            deps.push_back(createDependency("cli11", "2.3.2", "Command line parser", {}, false,
                                            true, "https://github.com/CLIUtils/CLI11",
                                            "BSD-3-Clause", "CLI"));
            break;

        case TemplateType::Lib:
            deps.push_back(createDependency("benchmark", "1.7.1", "Microbenchmark library", {},
                                            false, false, "https://github.com/google/benchmark",
                                            "Apache-2.0", "Testing"));
            break;

        case TemplateType::Network:
            deps.push_back(createDependency("asio", "1.24.0", "Asynchronous I/O library", {}, true,
                                            true, "https://github.com/chriskohlhoff/asio",
                                            "BSL-1.0", "Network"));
            deps.push_back(createDependency("nlohmann-json", "3.11.2", "JSON library", {}, true,
                                            true, "https://github.com/nlohmann/json", "MIT",
                                            "Utility"));
            break;

        case TemplateType::WebService:
            deps.push_back(createDependency(
                    "httplib", "0.14.0", "HTTP/HTTPS server and client library", {}, true, true,
                    "https://github.com/yhirose/cpp-httplib", "MIT", "Network"));
            deps.push_back(createDependency("nlohmann-json", "3.11.2", "JSON library", {}, true,
                                            true, "https://github.com/nlohmann/json", "MIT",
                                            "Utility"));
            deps.push_back(createDependency("sqlite3", "3.41.2", "SQLite database", {}, false,
                                            false, "https://www.sqlite.org/", "Public Domain",
                                            "Database"));
            break;

        case TemplateType::Gui:
            deps.push_back(createDependency("qt5", "5.15.8", "Cross-platform GUI toolkit",
                                            {"widgets", "network"}, true, false,
                                            "https://www.qt.io/", "LGPL-3.0", "GUI"));
            break;

        case TemplateType::Embedded:
            // Embedded projects typically use vendor-specific libraries
            deps.push_back(createDependency("freertos", "10.4.6", "Real-time operating system", {},
                                            false, false, "https://www.freertos.org/", "MIT",
                                            "RTOS"));
            break;
        ...
        case TemplateType::MultiExecutable:
            ...
            deps.push_back(createDependency("cli11", "2.3.2", "Command line parser", {}, false,
                                            true, "https://github.com/CLIUtils/CLI11",
                                            "BSD-3-Clause", "CLI"));
            deps.push_back(createDependency("toml11", "3.7.1", "TOML configuration parser", {},
                                            false, true, "https://github.com/ToruNiina/toml11",
                                            "MIT", "Config"));
            break;

        case TemplateType::QtApp:
            deps.push_back(createDependency("qt6", "6.5.0", "Cross-platform GUI toolkit",
                                            {"widgets", "network", "core"}, true, false,
                                            "https://www.qt.io/", "LGPL-3.0", "GUI"));
            break;

        case TemplateType::SfmlApp:
            deps.push_back(createDependency("sfml", "2.6.0", "Simple and Fast Multimedia Library",
                                            {"graphics", "window", "system"}, true, false,
                                            "https://www.sfml-dev.org/", "Zlib", "Graphics"));
            break;

        case TemplateType::BoostApp:
            deps.push_back(createDependency("boost", "1.82.0", "Boost C++ Libraries",
                                            {"system", "filesystem", "thread"}, true, false,
                                            "https://www.boost.org/", "BSL-1.0", "Utility"));
            break;

        case TemplateType::TestProject:
            deps.push_back(createDependency("gtest", "1.13.0", "Google Test framework", {}, true,
                                            false, "https://github.com/google/googletest",
                                            "BSD-3-Clause", "Testing"));
            deps.push_back(createDependency("gmock", "1.13.0", "Google Mock framework", {}, false,
                                            false, "https://github.com/google/googletest",
                                            "BSD-3-Clause", "Testing"));
            break;
        ...
        case TemplateType::Modules:
            ...
            deps.push_back(createDependency("fmt", "10.1.1", "Modern formatting library", {}, true,
                                            true, "https://github.com/fmtlib/fmt", "MIT",
                                            "Utility"));
            deps.push_back(createDependency("catch2", "3.4.0", "Modern testing framework", {},
                                            false, true, "https://github.com/catchorg/Catch2",
                                            "BSL-1.0", "Testing"));
            break;
    }
...
::std::vector<Dependency> DependencyManager::getTestingDependencies(TestFramework framework) {
    ...
    switch (framework) {
        case TestFramework::GTest:
            deps.push_back(createDependency("gtest", "1.13.0", "Google Test framework", {"gmock"},
                                            true, false, "https://github.com/google/googletest",
                                            "BSD-3-Clause", "Testing"));
            break;
        case TestFramework::Catch2:
            deps.push_back(createDependency("catch2", "3.3.2", "Modern C++ test framework", {},
                                            true, true, "https://github.com/catchorg/Catch2",
                                            "BSL-1.0", "Testing"));
            break;
        case TestFramework::Doctest:
            deps.push_back(createDependency("doctest", "2.4.9", "Lightweight C++ test framework",
                                            {}, true, true, "https://github.com/doctest/doctest",
                                            "MIT", "Testing"));
            break;
        case TestFramework::Boost:
            deps.push_back(createDependency("boost-test", "1.81.0", "Boost Test library", {}, true,
                                            false, "https://www.boost.org/", "BSL-1.0", "Testing"));
            break;
        default:
            break;
    }
...
bool DependencyManager::setupMSYS2(const ::std::string& projectPath) {
    ...
    if (mingwCheck.empty()) {
        TerminalUtils::showWarning(
                "Not in a MinGW environment. Please use MinGW64 or MinGW32 shell.");
        TerminalUtils::showInfo(
                "Launch MSYS2 MinGW64 shell for 64-bit builds or MinGW32 for 32-bit builds.");
        return false;
    }
...
// Enhanced dependency resolution
DependencyResolution DependencyManager::resolveDependencies(
        const std::vector<Dependency>& requested, const CliOptions& options) {
...
bool DependencyManager::setupFetchContent(const std::string& projectPath) {
    TerminalUtils::showNpmStyleProgress("Setting up FetchContent", 50,
                                        "Creating FetchContent configuration");
...
bool DependencyManager::checkPlatformCompatibility(const Dependency& dep,
