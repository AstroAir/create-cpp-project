...
public:
    ...
    std::vector<CompletionSuggestion> getCompletions(const std::string& input, GuidanceContext context);
    std::vector<CompletionSuggestion> getCommandCompletions(const std::string& partial);
    std::vector<CompletionSuggestion> getArgumentCompletions(const std::string& command, const std::string& partial);
    std::vector<CompletionSuggestion> getValueCompletions(const std::string& argument, const std::string& partial);
...
private:
    ...
    // Completion helpers
    std::vector<CompletionSuggestion> filterCompletions(const std::vector<CompletionSuggestion>& suggestions,
                                                       const std::string& input);
    void sortCompletionsByRelevance(std::vector<CompletionSuggestion>& suggestions, const std::string& input);
...
namespace ux_utils {
    ...
    int askChoice(const std::string& question, const std::vector<std::string>& options, int defaultChoice = 0);
