@echo off
REM Generate C++20 Modules Examples Script for Windows
REM This script creates all the module examples using cpp-scaffold

echo 🚀 Generating C++20 Modules Examples with cpp-scaffold
echo =======================================================

REM Check if cpp-scaffold is available
where cpp-scaffold >nul 2>nul
if %ERRORLEVEL% NEQ 0 (
