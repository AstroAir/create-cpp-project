...
TEST_F(FileUtilsEdgeCasesTest, PathManipulationEdgeCases) {
    ...
    EXPECT_EQ("path1/path2", FileUtils::combinePath("path1", "path2"));
    EXPECT_EQ("path1/path2", FileUtils::combinePath("path1/", "path2"));
    EXPECT_EQ("path1/path2", FileUtils::combinePath("path1", "/path2"));
    EXPECT_EQ("path1/path2", FileUtils::combinePath("path1/", "/path2"));
    ...
    EXPECT_EQ("path1", FileUtils::combinePath("path1", ""));
    ...
    EXPECT_EQ(".tar.gz", FileUtils::getFileExtension("file.tar.gz"));
